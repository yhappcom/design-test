...
abstract final class _V11Colors {
  ...
  static const lightTertiary = Color(0xFF7C847F);
  ...
  static const darkTertiary = Color(0xFF858D88);
...
class HomeV011 extends StatefulWidget {
  const HomeV011({super.key});

  @override
  State<HomeV011> createState() => _HomeV011State();
}

class _HomeV011State extends State<HomeV011> {
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(
                    ...
                    size: 16,
                    color:
                        active ? context.v11Accent : context.v11Secondary,
                  ),
  ...
  Widget build(BuildContext context) => Semantics(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Text(label, style: context.v11Utility),
          ),
        ),
      );
}
          ...
          child: ConstrainedBox(
            ...
            child: Center(
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: selected ? context.v11Surface : Colors.transparent,
                  borderRadius: BorderRadius.circular(7),
                ),
                child: Text(
                  value,
