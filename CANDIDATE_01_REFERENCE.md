# LogMate Home Candidate 01 — Preserved Comparison Reference

Status: **SEALED COMPARISON REFERENCE / NOT GENERATION INPUT**

Candidate 01 is preserved only so the owner can compare future candidates against it.

Rules:
- do not use Candidate 01 to generate a new design;
- do not transform, imitate, or derive a future candidate from it;
- do not treat it as the product baseline;
- do not promote it without an explicit owner decision.

Concept identity retained for recognition only:
- card-free operational working surface;
- calibrated operational axes;
- restrained hierarchy;
- selective operational type treatment;
