...
class _S extends State<HomeCandidate07Visual>{
 ...
 @override Widget build(BuildContext context){
  ...
  Widget heading(String s,{Widget? trailing})=>SizedBox(height:42,child:Row(children:[Text(s,style:tx(15,w:FontWeight.w700)),const Spacer(),if(trailing!=null)trailing]));
  ...
  Widget action(IconData icon,String label)=>Expanded(child:InkWell(onTap:(){},child:SizedBox(height:44,child:Row(mainAxisAlignment:MainAxisAlignment.center,children:[Icon(icon,size:16,color:sub),const SizedBox(width:7),Text(label,style:tx(13,w:FontWeight.w600))]))));
